...
public:
	GLuint compile_shaders(void)
	{
		...
		static const GLchar* vertex_shader_source[] =
		{
			...
			// 4x4 회전행렬을 모든 정점에 동일하게 곱해준다
			"	gl_Position=rotation_matrix * vertices[gl_VertexID]; \n"
	...
	virtual void render(double currentTime)
	{
		...
		// 시간에 따른 4x4 회전행렬을 선언하고 2번 location으로 보낸다
		vmath::mat4 rot_mat = vmath::rotate((float)currentTime * 45.0f, 0.0f, 0.0f, 1.0f);
		glUniformMatrix4fv(2, 1, GL_FALSE, rot_mat);
